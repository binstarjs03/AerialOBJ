...
public class ChunkRegionManager : ObservableObject, IChunkRegionManager
{
    ...
    private readonly IRegionDiskLoader _regionDiskLoader;
    private readonly IRegionDataImageModelFactory _regionDataImageModelFactory;
    ...
    public ChunkRegionManager(
        Setting setting,
        IRegionDiskLoader regionDiskLoader,
        IRegionDataImageModelFactory regionDataImageModelFactory,
        IChunkRenderer chunkRenderer,
        IDispatcher dispatcher)
    {
        _setting = setting;
        _regionDiskLoader = regionDiskLoader;
        _regionDataImageModelFactory = regionDataImageModelFactory;
    ...
    public void Update(PointZ<float> cameraPos, Size<int> screenSize, float unitMultiplier)
    {
    ...
    private void ProcessPendingRegion()
    {
        ...
        bool tryGetRegion(PointZ<int> regionCoords, [NotNullWhen(true)] out RegionDataImageModel? regionModel)
        {
            ...
            try
            {
                if (!_regionDiskLoader.TryGetRegion(regionCoords, _reinitializingCts.Token, out IRegion? region))
                    return false;
