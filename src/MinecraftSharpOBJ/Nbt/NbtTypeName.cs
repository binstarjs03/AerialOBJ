...
public static class NbtTypeName {
    public static readonly string NbtEnd = "End";
    public static readonly string NbtByte = "Byte";
    public static readonly string NbtShort = "Short";
    public static readonly string NbtInt = "Int";
